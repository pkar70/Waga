...
#End Region
    ...
    '    Await ObsluzBackgroundAsync()   ' w AirBox
    ...
    Protected Overrides Async Sub OnBackgroundActivated(args As BackgroundActivatedEventArgs)
        ...
        If args.TaskInstance.Task.Name = "AirBoxSensor_Timer" Then
            Await ObsluzBackgroundAsync()
            bObsluzone = True
        End If
